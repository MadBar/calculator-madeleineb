...
public class MainFrame {
	...
	private final JLabel lblOperation = new JLabel("Choose basic operation to perform to get result");
	private final JLabel lblNrToRaise = new JLabel("...Or insert a number below to raise");
